...
def tokenize(args):
    ...
    command = ['java','-cp','/content/drive/MyDrive/Summarization_Patents/stanford-corenlp-full-2017-06-09/stanford-corenlp-3.8.0.jar', 'edu.stanford.nlp.pipeline.StanfordCoreNLP', '-annotators', 'tokenize,ssplit',
...
class BertData():
    ...
    def preprocess(self, src, tgt, sent_labels, use_bert_basic_tokenizer=False, is_test=False):
        ...
        print(src_txt,'src_txt')
        print(src_subtoken_idxs,'src_subtoken_idxs', sent_labels,'sent_labels', tgt_subtoken_idxs,'tgt_subtoken_idxs', segments_ids,'segments_ids', cls_ids,'cls_ids', src_txt,'src_txt', tgt_txt,'tgt_txt')
